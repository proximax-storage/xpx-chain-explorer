...
Datatable = require('./components/pro/Datatable').default;
mdbDatatable = require('./components/pro/Datatable').default;
...
import SideNavNav, { mdbSideNavNav } from './components/pro/SideNavNav';
import SideNavCat, { mdbSideNavCat } from './components/pro/SideNavCat';
import SideNavItem, { mdbSideNavItem } from './components/pro/SideNavItem';
import SubMenu, { mdbSubMenu } from './components/pro/SubMenu';
import MdSwitch, { mdbSwitch } from './components/pro/Switch';
